...
def nelder_mead(x0,func,args=(),kwargs={}, method=None, bounds=None, constraints=(), tol=None, options=None):
    ...
    # Adaptive parameters improve convergence for higher dimensional problems (n > 20-40)
    n = len(simplex[0])
...
def bounds_check(x, bounds=None):
    """
...
def feasible_points_grid(bounds, constraints=None, grid_size=7, inf_repl=10.0**4):
    ...
    penalty_function_values = np.apply_along_axis(penalty, axis=1, arr = list_of_points, bounds=bounds, constraints=constraints)
